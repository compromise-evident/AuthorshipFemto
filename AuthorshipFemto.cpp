...
/*Version 1.0.2,  50-char keys & multi-way functions. This is a minuscule, super
...
which anyone verifies. Proof, doc: github.com/compromise-evident/AuthorshipFemto
...
{	bool bulk_verification_efficiency = false; /* DEFAULT=FALSE ELSE NO PLAINTEXT FILES.       Octet if broken >     |
	...
	{	/* Basic layout:
		...
		out_stream << "AuthorshipFemto.public v1.0.2=\r\n\r\n"; //34-byte header must be. Use "\r\n" for all returns (for max compatibility.)
