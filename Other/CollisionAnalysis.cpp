...
/* Place file AuthorshipFemto.private in the running directory. This probe gives
...
{	ifstream in_stream;
	...
	//Loads file AuthorshipFemto.private (must have been generated normally where bulk_verification_efficiency = false.)
	char functions[50400];
	char header_waste;
	in_stream.open("AuthorshipFemto.private");
	for(int a = 0; a < 51; a++) {in_stream.get(header_waste);}
